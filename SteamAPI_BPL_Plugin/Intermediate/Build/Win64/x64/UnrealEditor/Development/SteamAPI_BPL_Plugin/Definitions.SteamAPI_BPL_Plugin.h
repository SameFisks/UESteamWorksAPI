...
#define UE_PROJECT_NAME SteamSDKWrapper
#define UE_TARGET_NAME SteamSDKWrapperEditor
#define UE_MODULE_NAME "SteamAPI_BPL_Plugin"
#define UE_PLUGIN_NAME "SteamAPI_BPL_Plugin"
...
#define STEAMAPI_BPL_PLUGIN_API DLLEXPORT
