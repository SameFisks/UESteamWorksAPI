...
#include "UISteamInventory.generated.h"
...
UCLASS()
class UISteamInventory : public UBlueprintFunctionLibrary
{
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Steam Inventory", CompactNodeTitle = "SteamInventory"))
		static UISteamInventory* GetSteamInventory() { return UISteamInventory::StaticClass()->GetDefaultObject<UISteamInventory>(); }
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "SteamAPI|UISteamInventory")
	 ...
	 * @return void
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamAPI|UISteamInventory")
...
//
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SteamAPI|UISteamInventory")
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamInventory", meta = (DisplayName = "OnSteamInventoryDefinitionUpdate"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamInventory", meta = (DisplayName = "OnSteamInventoryEligiblePromoItemDefIDs"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamInventory", meta = (DisplayName = "OnSteamInventoryFullUpdate"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamInventory", meta = (DisplayName = "OnSteamInventoryResultReady"))
		FOnSteamInventoryResultReadyDelegate m_OnSteamInventoryResultReady;

	/** Returned after StartPurchase is called. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamInventory", meta = (DisplayName = "OnSteamInventoryStartPurchaseResult"))
		FOnSteamInventoryStartPurchaseResultDelegate m_OnSteamInventoryStartPurchaseResult;

	/** Returned after RequestPrices is called. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamInventory", meta = (DisplayName = "OnSteamInventoryRequestPricesResult"))
		FOnSteamInventoryRequestPricesResultDelegate m_OnSteamInventoryRequestPricesResult;
//
//protected:
//private:
	STEAM_CALLBACK_MANUAL(UISteamInventory, OnSteamInventoryDefinitionUpdate, SteamInventoryDefinitionUpdate_t, OnSteamInventoryDefinitionUpdateCallback);
	STEAM_CALLBACK_MANUAL(UISteamInventory, OnSteamInventoryEligiblePromoItemDefIDs, SteamInventoryEligiblePromoItemDefIDs_t, OnSteamInventoryEligiblePromoItemDefIDsCallback);
	STEAM_CALLBACK_MANUAL(UISteamInventory, OnSteamInventoryFullUpdate, SteamInventoryFullUpdate_t, OnSteamInventoryFullUpdateCallback);
	STEAM_CALLBACK_MANUAL(UISteamInventory, OnSteamInventoryResultReady, SteamInventoryResultReady_t, OnSteamInventoryResultReadyCallback);
	STEAM_CALLBACK_MANUAL(UISteamInventory, OnSteamInventoryStartPurchaseResult, SteamInventoryStartPurchaseResult_t, OnSteamInventoryStartPurchaseResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamInventory, OnSteamInventoryRequestPricesResult, SteamInventoryRequestPricesResult_t, OnSteamInventoryRequestPricesResultCallback);
};
