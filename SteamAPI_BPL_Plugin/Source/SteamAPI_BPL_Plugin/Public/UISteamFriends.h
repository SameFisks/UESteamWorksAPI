...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Steam Friends", CompactNodeTitle = "SteamFriends"))
		static UISteamFriends* GetSteamFriends() { return UISteamFriends::StaticClass()->GetDefaultObject<UISteamFriends>(); }
	 ...
	 * @return void
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamAPI|UISteamFriends")
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnAvatarImageLoaded"))
		FOnAvatarImageLoadedDelegate m_OnAvatarImageLoaded;

	/** Marks the return of a request officer list call. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnClanOfficerListResponse"))
		FOnClanOfficerListResponseDelegate m_OnClanOfficerListResponse;

	/** Called when a Steam group activity has received. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnDownloadClanActivityCountsResult"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnFriendRichPresenceUpdate"))
		FOnFriendRichPresenceUpdateDelegate m_OnFriendRichPresenceUpdate;

	/** Returns the result of EnumerateFollowingList. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnFriendsEnumerateFollowingList"))
		FOnFriendsEnumerateFollowingListDelegate m_OnFriendsEnumerateFollowingList;

	/** Returns the result of GetFollowerCount. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnFriendsGetFollowerCount"))
		FOnFriendsGetFollowerCountDelegate m_OnFriendsGetFollowerCount;

	/** Returns the result of IsFollowing. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnFriendsIsFollowing"))
		FOnFriendsIsFollowingDelegate m_OnFriendsIsFollowing;

	/** Called when a user has joined a Steam group chat that the we are in. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnGameConnectedChatJoin"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnGameConnectedChatLeave"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnGameConnectedClanChatMsg"))
		FOnGameConnectedClanChatMsgDelegate m_OnGameConnectedClanChatMsg;

	/** Called when chat message has been received from a friend. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnGameConnectedFriendChatMsg"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnGameLobbyJoinRequested"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnGameOverlayActivated"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnGameRichPresenceJoinRequested"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnGameServerChangeRequested"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnJoinClanChatRoomCompletionResult"))
		FOnJoinClanChatRoomCompletionResultDelegate m_OnJoinClanChatRoomCompletionResult;

	/** Called whenever a friends' status changes. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnPersonaStateChange"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamFriends", meta = (DisplayName = "OnSetPersonaNameResponse"))
		FOnSetPersonaNameResponseDelegate m_OnSetPersonaNameResponse;

private:
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnAvatarImageLoaded, AvatarImageLoaded_t, OnAvatarImageLoadedCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnClanOfficerListResponse, ClanOfficerListResponse_t, OnClanOfficerListResponseCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnDownloadClanActivityCountsResult, DownloadClanActivityCountsResult_t, OnDownloadClanActivityCountsResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnFriendRichPresenceUpdate, FriendRichPresenceUpdate_t, OnFriendRichPresenceUpdateCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnFriendsEnumerateFollowingList, FriendsEnumerateFollowingList_t, OnFriendsEnumerateFollowingListCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnFriendsGetFollowerCount, FriendsGetFollowerCount_t, OnFriendsGetFollowerCountCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnFriendsIsFollowing, FriendsIsFollowing_t, OnFriendsIsFollowingCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnGameConnectedChatJoin, GameConnectedChatJoin_t, OnGameConnectedChatJoinCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnGameConnectedChatLeave, GameConnectedChatLeave_t, OnGameConnectedChatLeaveCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnGameConnectedClanChatMsg, GameConnectedClanChatMsg_t, OnGameConnectedClanChatMsgCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnGameConnectedFriendChatMsg, GameConnectedFriendChatMsg_t, OnGameConnectedFriendChatMsgCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnGameLobbyJoinRequested, GameLobbyJoinRequested_t, OnGameLobbyJoinRequestedCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnGameOverlayActivated, GameOverlayActivated_t, OnGameOverlayActivatedCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnGameRichPresenceJoinRequested, GameRichPresenceJoinRequested_t, OnGameRichPresenceJoinRequestedCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnGameServerChangeRequested, GameServerChangeRequested_t, OnGameServerChangeRequestedCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnJoinClanChatRoomCompletionResult, JoinClanChatRoomCompletionResult_t, OnJoinClanChatRoomCompletionResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnPersonaStateChange, PersonaStateChange_t, OnPersonaStateChangeCallback);
	STEAM_CALLBACK_MANUAL(UISteamFriends, OnSetPersonaNameResponse, SetPersonaNameResponse_t, OnSetPersonaNameResponseCallback);
