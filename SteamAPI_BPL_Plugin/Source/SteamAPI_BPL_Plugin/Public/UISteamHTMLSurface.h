...
#include "UISteamHTMLSurface.generated.h"
...
UCLASS()
class UISteamHTMLSurface : public UBlueprintFunctionLibrary
{
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Steam HTML Surface", CompactNodeTitle = "SteamHTMLSurface"))
		static UISteamHTMLSurface* GetSteamHTMLSurface() { return UISteamHTMLSurface::StaticClass()->GetDefaultObject<UISteamHTMLSurface>(); }
	 ...
	 * @return void
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamAPI|UISteamHTMLSurface")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SteamAPI|UISteamHTMLSurface")
...
protected:
private:
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLBrowserReady, HTML_BrowserReady_t, OnHTMLBrowserReadyCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLCanGoBackAndForward, HTML_CanGoBackAndForward_t, OnHTMLCanGoBackAndForwardCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLChangedTitle, HTML_ChangedTitle_t, OnHTMLChangedTitleCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLCloseBrowser, HTML_CloseBrowser_t, OnHTMLCloseBrowserCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLFileOpenDialog, HTML_FileOpenDialog_t, OnHTMLFileOpenDialogCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLFinishedRequest, HTML_FinishedRequest_t, OnHTMLFinishedRequestCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLHideToolTip, HTML_HideToolTip_t, OnHTMLHideToolTipCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLHorizontalScroll, HTML_HorizontalScroll_t, OnHTMLHorizontalScrollCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLJSAlert, HTML_JSAlert_t, OnHTMLJSAlertCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLJSConfirm, HTML_JSConfirm_t, OnHTMLJSConfirmCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLLinkAtPosition, HTML_LinkAtPosition_t, OnHTMLLinkAtPositionCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLNeedsPaint, HTML_NeedsPaint_t, OnHTMLNeedsPaintCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLNewWindow, HTML_NewWindow_t, OnHTMLNewWindowCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLOpenLinkInNewTab, HTML_OpenLinkInNewTab_t, OnHTMLOpenLinkInNewTabCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLSearchResults, HTML_SearchResults_t, OnHTMLSearchResultsCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLSetCursor, HTML_SetCursor_t, OnHTMLSetCursorCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLShowToolTip, HTML_ShowToolTip_t, OnHTMLShowToolTipCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLStartRequest, HTML_StartRequest_t, OnHTMLStartRequestCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLStatusText, HTML_StatusText_t, OnHTMLStatusTextCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLUpdateToolTip, HTML_UpdateToolTip_t, OnHTMLUpdateToolTipCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLURLChanged, HTML_URLChanged_t, OnHTMLURLChangedCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTMLSurface, OnHTMLVerticalScroll, HTML_VerticalScroll_t, OnHTMLVerticalScrollCallback);
};
