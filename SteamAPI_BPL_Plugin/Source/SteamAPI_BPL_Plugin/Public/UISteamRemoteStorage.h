...
#include "UISteamRemoteStorage.generated.h"
...
UCLASS()
class UISteamRemoteStorage : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()


public:
	UISteamRemoteStorage();
	~UISteamRemoteStorage();

	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Steam Remote Storage", CompactNodeTitle = "SteamRemoteStorage"))
		static UISteamRemoteStorage* GetSteamRemoteStorage() { return UISteamRemoteStorage::StaticClass()->GetDefaultObject<UISteamRemoteStorage>(); }
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "SteamAPI|UISteamRemoteStorage")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SteamAPI|UISteamRemoteStorage")
	 ...
	 * @return void
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamAPI|UISteamRemoteStorage")
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamRemoteStorage", meta = (DisplayName = "OnRemoteStorageDownloadUGCResult"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamRemoteStorage", meta = (DisplayName = "OnRemoteStorageFileReadAsyncComplete"))
		FOnRemoteStorageFileReadAsyncCompleteDelegate m_OnRemoteStorageFileReadAsyncComplete;

	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamRemoteStorage", meta = (DisplayName = "OnRemoteStorageFileShareResult"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamRemoteStorage", meta = (DisplayName = "OnRemoteStorageFileWriteAsyncComplete"))
		FOnRemoteStorageFileWriteAsyncCompleteDelegate m_OnRemoteStorageFileWriteAsyncComplete;

	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamRemoteStorage", meta = (DisplayName = "OnRemoteStoragePublishedFileSubscribed"))
		FOnRemoteStoragePublishedFileSubscribedDelegate m_OnRemoteStoragePublishedFileSubscribed;

	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamRemoteStorage", meta = (DisplayName = "OnRemoteStoragePublishedFileUnsubscribed"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamRemoteStorage", meta = (DisplayName = "OnRemoteStorageSubscribePublishedFileResult"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamRemoteStorage", meta = (DisplayName = "OnRemoteStorageUnsubscribePublishedFileResult"))
		FOnRemoteStorageUnsubscribePublishedFileResultDelegate m_OnRemoteStorageUnsubscribePublishedFileResult;

protected:
private:
	STEAM_CALLBACK_MANUAL(UISteamRemoteStorage, OnRemoteStorageDownloadUGCResult, RemoteStorageDownloadUGCResult_t, OnRemoteStorageDownloadUGCResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamRemoteStorage, OnRemoteStorageFileReadAsyncComplete, RemoteStorageFileReadAsyncComplete_t, OnRemoteStorageFileReadAsyncCompleteCallback);
	STEAM_CALLBACK_MANUAL(UISteamRemoteStorage, OnRemoteStorageFileShareResult, RemoteStorageFileShareResult_t, OnRemoteStorageFileShareResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamRemoteStorage, OnRemoteStorageFileWriteAsyncComplete, RemoteStorageFileWriteAsyncComplete_t, OnRemoteStorageFileWriteAsyncCompleteCallback);
	STEAM_CALLBACK_MANUAL(UISteamRemoteStorage, OnRemoteStoragePublishedFileSubscribed, RemoteStoragePublishedFileSubscribed_t, OnRemoteStoragePublishedFileSubscribedCallback);
	STEAM_CALLBACK_MANUAL(UISteamRemoteStorage, OnRemoteStoragePublishedFileUnsubscribed, RemoteStoragePublishedFileUnsubscribed_t, OnRemoteStoragePublishedFileUnsubscribedCallback);
	STEAM_CALLBACK_MANUAL(UISteamRemoteStorage, OnRemoteStorageSubscribePublishedFileResult, RemoteStorageSubscribePublishedFileResult_t, OnRemoteStorageSubscribePublishedFileResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamRemoteStorage, OnRemoteStorageUnsubscribePublishedFileResult, RemoteStorageUnsubscribePublishedFileResult_t, OnRemoteStorageUnsubscribePublishedFileResultCallback);
};
