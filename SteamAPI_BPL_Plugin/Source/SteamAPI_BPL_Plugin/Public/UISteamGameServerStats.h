...
#include "UISteamGameServerStats.generated.h"
...
UCLASS()
class UISteamGameServerStats : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()


public:
	UISteamGameServerStats();
	~UISteamGameServerStats();

	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Steam Game Server Stats", CompactNodeTitle = "SteamGameServerStats"))
		static UISteamGameServerStats* GetSteamGameServerStats() { return UISteamGameServerStats::StaticClass()->GetDefaultObject<UISteamGameServerStats>(); }
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SteamAPI|UISteamGameServerStats")
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamGameServerStats", meta = (DisplayName = "OnGSStatsReceived"))
		FOnGSStatsReceivedDelegate m_OnGSStatsReceived;

	/** Result of a request to store the user stats. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamGameServerStats", meta = (DisplayName = "OnGSStatsStored"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamGameServerStats", meta = (DisplayName = "OnGSStatsUnloaded"))
		FOnGSStatsUnloadedDelegate m_OnGSStatsUnloaded;

protected:
private:
	STEAM_CALLBACK_MANUAL(UISteamGameServerStats, OnGSStatsReceived, GSStatsReceived_t, OnGSStatsReceivedCallback);
	STEAM_CALLBACK_MANUAL(UISteamGameServerStats, OnGSStatsStored, GSStatsStored_t, OnGSStatsStoredCallback);
	STEAM_CALLBACK_MANUAL(UISteamGameServerStats, OnGSStatsUnloaded, GSStatsUnloaded_t, OnGSStatsUnloadedCallback);
};
