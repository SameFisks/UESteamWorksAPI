...
#include "UISteamGameServer.generated.h"
...
UCLASS()
class UISteamGameServer : public UBlueprintFunctionLibrary
{
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamBridgeCore", meta = (DisplayName = "Steam Game Server", CompactNodeTitle = "SteamGameServer"))
		static UISteamGameServer* GetSteamGameServer() { return UISteamGameServer::StaticClass()->GetDefaultObject<UISteamGameServer>(); }
...
protected:
private:
	STEAM_GAMESERVER_CALLBACK_MANUAL(UISteamGameServer, OnAssociateWithClanResult, AssociateWithClanResult_t, OnAssociateWithClanResultCallback);
	STEAM_GAMESERVER_CALLBACK_MANUAL(UISteamGameServer, OnComputeNewPlayerCompatibilityResult, ComputeNewPlayerCompatibilityResult_t, OnComputeNewPlayerCompatibilityResultCallback);
	STEAM_GAMESERVER_CALLBACK_MANUAL(UISteamGameServer, OnGSClientApprove, GSClientApprove_t, OnGSClientApproveCallback);
	STEAM_GAMESERVER_CALLBACK_MANUAL(UISteamGameServer, OnGSClientDeny, GSClientDeny_t, OnGSClientDenyCallback);
	STEAM_GAMESERVER_CALLBACK_MANUAL(UISteamGameServer, OnGSClientGroupStatus, GSClientGroupStatus_t, OnGSClientGroupStatusCallback);
	STEAM_GAMESERVER_CALLBACK_MANUAL(UISteamGameServer, OnGSClientKick, GSClientKick_t, OnGSClientKickCallback);
	STEAM_GAMESERVER_CALLBACK_MANUAL(UISteamGameServer, OnGSPolicyResponse, GSPolicyResponse_t, OnGSPolicyResponseCallback);
