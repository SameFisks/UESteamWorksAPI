...
#include "UISteamInput.generated.h"

//Interface for supporting Xbox, PlayStation, Switch and Steam Controllers.
UCLASS()
class UISteamInput : public UBlueprintFunctionLibrary
{
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Steam Input", CompactNodeTitle = "SteamInput"))
		static UISteamInput* GetSteamInput() { return UISteamInput::StaticClass()->GetDefaultObject<UISteamInput>(); }
	 ...
	 * @return void
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamAPI|UISteamInput")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SteamAPI|UISteamInput")
