...
#include "UISteamUserStats.generated.h"
...
UCLASS()
class UISteamUserStats : public UBlueprintFunctionLibrary
{
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Get Steam User Stats", CompactNodeTitle = "GetSteamUserStats"))
		static UISteamUserStats* GetSteamUserStats() { return UISteamUserStats::StaticClass()->GetDefaultObject<UISteamUserStats>(); }
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "SteamAPI|UISteamUserStats")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SteamAPI|UISteamUserStats")
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnGlobalAchievementPercentagesReady"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnGlobalStatsReceived"))
		FOnGlobalStatsReceivedDelegate m_OnGlobalStatsReceived;

	/** Result when finding a leaderboard. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnLeaderboardFindResult"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnLeaderboardScoresDownloaded"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnLeaderboardScoreUploaded"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnLeaderboardUGCSet"))
		FOnLeaderboardUGCSetDelegate m_OnLeaderboardUGCSet;

	/** Gets the current number of players for the current AppId. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnNumberOfCurrentPlayers"))
		FOnNumberOfCurrentPlayersDelegate m_OnNumberOfCurrentPlayers;

	/** Result of an achievement icon that has been fetched */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnUserAchievementIconFetched"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnUserAchievementStored"))
		FOnUserAchievementStoredDelegate m_OnUserAchievementStored;

	/** Called when the latest stats and achievements for a specific user (including the local user) have been received from the server. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnUserStatsReceived"))
		FOnUserStatsReceivedDelegate m_OnUserStatsReceived;

	/** Result of a request to store the user stats.*/
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnUserStatsStored"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamUserStats", meta = (DisplayName = "OnUserStatsUnloaded"))
		FOnUserStatsUnloadedDelegate m_OnUserStatsUnloaded;

protected:
private:
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnGlobalAchievementPercentagesReady, GlobalAchievementPercentagesReady_t, OnGlobalAchievementPercentagesReadyCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnGlobalStatsReceived, GlobalStatsReceived_t, OnGlobalStatsReceivedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnLeaderboardFindResult, LeaderboardFindResult_t, OnLeaderboardFindResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnLeaderboardScoresDownloaded, LeaderboardScoresDownloaded_t, OnLeaderboardScoresDownloadedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnLeaderboardScoreUploaded, LeaderboardScoreUploaded_t, OnLeaderboardScoreUploadedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnLeaderboardUGCSet, LeaderboardUGCSet_t, OnLeaderboardUGCSetCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnNumberOfCurrentPlayers, NumberOfCurrentPlayers_t, OnNumberOfCurrentPlayersCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnUserAchievementIconFetched, UserAchievementIconFetched_t, OnUserAchievementIconFetchedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnUserAchievementStored, UserAchievementStored_t, OnUserAchievementStoredCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnUserStatsReceived, UserStatsReceived_t, OnUserStatsReceivedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnUserStatsStored, UserStatsStored_t, OnUserStatsStoredCallback);
	STEAM_CALLBACK_MANUAL(UISteamUserStats, OnUserStatsUnloaded, UserStatsUnloaded_t, OnUserStatsUnloadedCallback);
