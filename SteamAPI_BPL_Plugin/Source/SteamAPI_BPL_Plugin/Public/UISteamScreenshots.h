...
#include "UISteamScreenshots.generated.h"
...
UCLASS()
class UISteamScreenshots : public UBlueprintFunctionLibrary
{
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Get Steam Screenshots", CompactNodeTitle = "GetSteamScreenshots"))
		static UISteamScreenshots* GetSteamScreenshots() { return UISteamScreenshots::StaticClass()->GetDefaultObject<UISteamScreenshots>(); }
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "SteamAPI|UISteamScreenshots")
	 ...
	 * @return void
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamAPI|UISteamScreenshots")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SteamAPI|UISteamScreenshots")
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamScreenshots", meta = (DisplayName = "OnScreenshotReady"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamScreenshots", meta = (DisplayName = "OnScreenshotRequested"))
		FOnScreenshotRequestedDelegate m_OnScreenshotRequested;

protected:
private:
	STEAM_CALLBACK_MANUAL(UISteamScreenshots, OnScreenshotReady, ScreenshotReady_t, OnScreenshotReadyCallback);
	STEAM_CALLBACK_MANUAL(UISteamScreenshots, OnScreenshotRequested, ScreenshotRequested_t, OnScreenshotRequestedCallback);
};
