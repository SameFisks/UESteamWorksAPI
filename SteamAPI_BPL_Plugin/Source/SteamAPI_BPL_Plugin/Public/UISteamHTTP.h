...
#include "UISteamHTTP.generated.h"
...
UCLASS()
class UISteamHTTP : public UBlueprintFunctionLibrary
{
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Steam HTTP", CompactNodeTitle = "SteamHTTP"))
		static UISteamHTTP* GetSteamHTTP() { return UISteamHTTP::StaticClass()->GetDefaultObject<UISteamHTTP>(); }
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "SteamAPI|UISteamHTTP")
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamHTTP", meta = (DisplayName = "OnHTTPRequestCompleted"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamHTTP", meta = (DisplayName = "OnHTTPRequestDataReceived"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|UISteamHTTP", meta = (DisplayName = "OnHTTPRequestHeadersReceived"))
		FOnHTTPRequestHeadersReceivedDelegate m_OnHTTPRequestHeadersReceived;

protected:
private:
	STEAM_CALLBACK_MANUAL(UISteamHTTP, OnHTTPRequestCompleted, HTTPRequestCompleted_t, OnHTTPRequestCompletedCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTTP, OnHTTPRequestDataReceived, HTTPRequestDataReceived_t, OnHTTPRequestDataReceivedCallback);
	STEAM_CALLBACK_MANUAL(UISteamHTTP, OnHTTPRequestHeadersReceived, HTTPRequestHeadersReceived_t, OnHTTPRequestHeadersReceivedCallback);
};
