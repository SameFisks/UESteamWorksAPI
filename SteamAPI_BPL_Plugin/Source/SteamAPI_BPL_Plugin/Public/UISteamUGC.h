...
#include "UISteamUGC.generated.h"
...
UCLASS()
class UISteamUGC : public UBlueprintFunctionLibrary
{
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SteamAPI", meta = (DisplayName = "Get Steam UGC", CompactNodeTitle = "GetSteamUGC"))
		static UISteamUGC* GetSteamUGC() { return UISteamUGC::StaticClass()->GetDefaultObject<UISteamUGC>(); }
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "SteamAPI|ISteamUGC")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "SteamAPI|ISteamUGC")
	 ...
	 * @return void
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamAPI|ISteamUGC")
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnAddAppDependencyResult"))
		FOnAddAppDependencyResultDelegate m_OnAddAppDependencyResult;

	/** The result of a call to AddDependency. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnAddUGCDependencyResult"))
		FOnAddUGCDependencyResultDelegate m_OnAddUGCDependencyResult;

	/** Called when a new workshop item has been created. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnCreateItemResult"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnDownloadItemResult"))
		FOnDownloadItemResultDelegate m_OnDownloadItemResult;

	/** Called when getting the app dependencies for an item. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnGetAppDependenciesResult"))
		FOnGetAppDependenciesResultDelegate m_OnGetAppDependenciesResult;

	/** Called when an attempt at deleting an item completes. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnDeleteItemResult"))
		FOnDeleteItemResultDelegate m_OnDeleteItemResult;

	/** Called when getting the users vote status on an item. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnGetUserItemVoteResult"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnItemInstalled"))
		FOnItemInstalledDelegate m_OnItemInstalled;

	/** Purpose: The result of a call to RemoveAppDependency. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnRemoveAppDependencyResult"))
		FOnRemoveAppDependencyResultDelegate m_OnRemoveAppDependencyResult;

	/** Purpose: The result of a call to RemoveDependency. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnRemoveUGCDependencyResult"))
		FOnRemoveUGCDependencyResultDelegate m_OnRemoveUGCDependencyResult;

	/** Called when the user has voted on an item. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnSetUserItemVoteResult"))
		FOnSetUserItemVoteResultDelegate m_OnSetUserItemVoteResult;

	/** Called when workshop item playtime tracking has started. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnStartPlaytimeTrackingResult"))
		FOnStartPlaytimeTrackingResultDelegate m_OnStartPlaytimeTrackingResult;

	/** Called when a UGC query request completes. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnSteamUGCQueryCompleted"))
		FOnSteamUGCQueryCompletedDelegate m_OnSteamUGCQueryCompleted;

	/** Called when workshop item playtime tracking has stopped. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnStopPlaytimeTrackingResult"))
		FOnStopPlaytimeTrackingResultDelegate m_OnStopPlaytimeTrackingResult;

	/** Called when an item update has completed. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnSubmitItemUpdateResult"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUGC", meta = (DisplayName = "OnUserFavoriteItemsListChanged"))
		FOnUserFavoriteItemsListChangedDelegate m_OnUserFavoriteItemsListChanged;

protected:
private:
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnAddAppDependencyResult, AddAppDependencyResult_t, OnAddAppDependencyResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnAddUGCDependencyResult, AddUGCDependencyResult_t, OnAddUGCDependencyResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnCreateItemResult, CreateItemResult_t, OnCreateItemResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnDownloadItemResult, DownloadItemResult_t, OnDownloadItemResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnGetAppDependenciesResult, GetAppDependenciesResult_t, OnGetAppDependenciesResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnDeleteItemResult, DeleteItemResult_t, OnDeleteItemResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnGetUserItemVoteResult, GetUserItemVoteResult_t, OnGetUserItemVoteResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnItemInstalled, ItemInstalled_t, OnItemInstalledCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnRemoveAppDependencyResult, RemoveAppDependencyResult_t, OnRemoveAppDependencyResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnRemoveUGCDependencyResult, RemoveUGCDependencyResult_t, OnRemoveUGCDependencyResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnSetUserItemVoteResult, SetUserItemVoteResult_t, OnSetUserItemVoteResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnStartPlaytimeTrackingResult, StartPlaytimeTrackingResult_t, OnStartPlaytimeTrackingResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnSteamUGCQueryCompleted, SteamUGCQueryCompleted_t, OnSteamUGCQueryCompletedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnStopPlaytimeTrackingResult, StopPlaytimeTrackingResult_t, OnStopPlaytimeTrackingResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnSubmitItemUpdateResult, SubmitItemUpdateResult_t, OnSubmitItemUpdateResultCallback);
	STEAM_CALLBACK_MANUAL(UISteamUGC, OnUserFavoriteItemsListChanged, UserFavoriteItemsListChanged_t, OnUserFavoriteItemsListChangedCallback);
};
