...
public:
	 ...
	 * @return void
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamAPI|ISteamUser")
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnClientGameServerDeny"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnDurationControl"))
		FOnDurationControlDelegate m_OnDurationControl;

	/** Called when an encrypted application ticket has been received. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnEncryptedAppTicketResponse"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnGameWebCallback"))
		FOnGameWebCallbackDelegate m_OnGameWeb;

	/** Result when creating an auth session ticket. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnGetAuthSessionTicketResponse"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnIPCFailure"))
		FOnIPCFailureDelegate m_IPCFailure;

	/** Called whenever the users licenses (owned packages) changes. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnLicensesUpdated"))
		FOnLicensesUpdatedDelegate m_OnLicensesUpdated;

	/** Called when a user has responded to a microtransaction authorization request. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnMicroTxnAuthorizationResponse"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnSteamServerConnectFailure"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnSteamServersConnected"))
	 ...
	 */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnSteamServersDisconnected"))
	...
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnStoreAuthURLResponse"))
		FOnStoreAuthURLResponseDelegate m_OnStoreAuthURLResponse;

	/** Called when an auth ticket has been validated. */
	UPROPERTY(BlueprintAssignable, Category = "SteamAPI|ISteamUser", meta = (DisplayName = "OnValidateAuthTicketResponse"))
		FOnValidateAuthTicketResponseDelegate m_OnValidateAuthTicketResponse;

protected:
private:
	STEAM_CALLBACK_MANUAL(UISteamUser, OnClientGameServerDeny, ClientGameServerDeny_t, OnClientGameServerDenyCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnDurationControl, DurationControl_t, OnDurationControlCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnEncryptedAppTicketResponse, EncryptedAppTicketResponse_t, OnEncryptedAppTicketResponseCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnGameWeb, GameWebCallback_t, OnGameWebCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnGetAuthSessionTicketResponse, GetAuthSessionTicketResponse_t, OnGetAuthSessionTicketResponseCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnIPCFailure, IPCFailure_t, OnIPCFailureCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnLicensesUpdated, LicensesUpdated_t, OnLicensesUpdatedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnMicroTxnAuthorizationResponse, MicroTxnAuthorizationResponse_t, OnMicroTxnAuthorizationResponseCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnSteamServerConnectFailure, SteamServerConnectFailure_t, OnSteamServerConnectFailureCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnSteamServersConnected, SteamServersConnected_t, OnSteamServersConnectedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnSteamServersDisconnected, SteamServersDisconnected_t, OnSteamServersDisconnectedCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnStoreAuthURLResponse, StoreAuthURLResponse_t, OnStoreAuthURLResponseCallback);
	STEAM_CALLBACK_MANUAL(UISteamUser, OnValidateAuthTicketResponse, ValidateAuthTicketResponse_t, OnValidateAuthTicketResponseCallback);
